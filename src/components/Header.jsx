...
export default function Header() {
  ...
  return (
    <div className="h-screen bg-black ">
      ...
      <div className="text-center pt-40 relative z-10">
      ...
      <div
        className={`absolute mt-28 bottom-25 left-1/2 transform -translate-x-1/2 animate-bounce  transition-all duration-1800 delay-1000 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        }`}
      >
