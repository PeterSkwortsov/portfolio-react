...
import { scenes } from "../worksFiles/ManyCar";
...
export const Overlay = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute w-full md:w-1/2 lg:w-1/2 z-10  bottom-0  right-0 flex flex-col justify-between pointer-events-none text-black ${
          visible ? "" : "opacity-0"
      ...
      >
        ...
        <div className="bg-gradient-to-t from-white/100 pt-20 pb-10 p-4 flex items-center flex-col text-center">
          ...
          <div className="flex items-center gap-12 mt-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm opacity-80">Один заряд</p>
            </div>
          </div>
        </div>
      </div>
