...
const handleGoBack = () => {
...

  {
    ...
    const projectData = {
      ...
      overview:
        "Большое количество картин художников с возможностью добавления в избранное, сохранение в LocalStorage. Мой дизайн. Не является интернет-магазином.",
      goals: [
        "Создать интуитивно понятный сайт",
        "Сохранить изображения картин своих родителей на память",
