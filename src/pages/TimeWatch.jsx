...
export default function Ships() {
 ...
 const handleGoBack = () => {
  ...
  const projectData = {
    title: "Лендинг умных часов",
    description: "С использованием 3D модели",
    imageUrl: "/watch.jpg",
    githubUrl: "https://github.com/PeterSkwortsov/timewatch",
    overview:
      "Это пример лендинга специально созданного для демонстрации несуществующей модели часов, вместо них может быть другой продукт ",
    goals: [
      "Добится wow-эффекта анимации часов во время скролла страницы",
      "Совремнный дизайн",
      "Размещение УТП на странице",
      "Мобильная версия, плавный слайдер",
    ],

    technologies: ["React", "Tailwind", "R3F"],
    results: [
    ...
    liveDemoUrl: "https://timewatch-hazel.vercel.app/",
    status: "Завершен",
    duration: "1 неделя",
  };
